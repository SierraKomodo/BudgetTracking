...
switch ($_ENV["DB_DRIVER"]) {
    ...
    default:
        $alert = new Alert("Database Failure", "The database failed to initialize: Invalid DB driver.", BootstrapColor::Danger);
...
try {
    ...
    $alert = new Alert("Database Failure", "The database failed to initialize: {$e->getMessage()}.", BootstrapColor::Danger);
    $htmlOut .= $alert->render();
}
